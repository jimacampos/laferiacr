...
export const dictionaries: Record<Language, Messages> = {
  es: {
    ...
    "provenance.official": "Oficial (lista 2026)",
    "provenance.community": "Agregada por la comunidad",
    "provenance.officialShort": "Oficial",
    "provenance.communityShort": "Comunidad",
    ...
    "submitMarket.subtitle":
      "¿Conocés una feria que no está en la lista? Proponéla y la comunidad la confirma.",
    "submitMarket.signInRequired": "Iniciá sesión para proponer una feria.",
    "submitMarket.name": "Nombre de la feria",
    "submitMarket.namePlaceholder": "Ej.: Feria de Naranjo",
    "submitMarket.region": "Región",
    "submitMarket.regionPlaceholder": "Elegí una región",
    "submitMarket.days": "Días",
    "submitMarket.hours": "Horario",
    "submitMarket.hoursPlaceholder": "Ej.: 6am–1pm",
    "submitMarket.reference": "Punto de referencia",
    "submitMarket.referencePlaceholder": "Ej.: Contiguo al Palí",
    "submitMarket.mapUrl": "Enlace de Google Maps",
    "submitMarket.mapUrlPlaceholder": "https://maps.google.com/…",
    "submitMarket.organizer": "Organiza",
    "submitMarket.phone": "Teléfono",
    "submitMarket.location": "Ubicación",
    "submitMarket.pickOnMap": "Tocá el mapa para colocar el pin (opcional).",
    "submitMarket.useMyLocation": "Usar mi ubicación",
    "submitMarket.locationSelected": "Ubicación seleccionada",
    "submitMarket.submit": "Proponer feria",
    "submitMarket.submitting": "Enviando…",
    "submitMarket.success":
      "¡Gracias! Tu feria quedó pendiente de confirmación por la comunidad.",
    "submitMarket.viewPending": "Ver ferias propuestas",
    "submitMarket.error": "No se pudo enviar. Revisá los campos e intentá de nuevo.",
    "submitMarket.rateLimited": "Demasiados envíos. Probá más tarde.",
    "submitMarket.required": "Completá el nombre, la región y al menos un día.",

    "duplicates.warningTitle": "Posibles duplicados",
    "duplicates.warningBody":
      "Ya existen ferias parecidas. Revisalas antes de continuar; de todas formas podés proponerla.",
    "duplicates.near": "a {meters} m",
    "duplicates.checking": "Buscando duplicados…",

    "submissions.title": "Ferias propuestas",
    "submissions.subtitle":
      "Ferias agregadas por la comunidad, esperando confirmación. Iniciá sesión para confirmarlas.",
    "submissions.empty": "No hay ferias propuestas por ahora.",
    "submissions.addCta": "Proponer una feria",
    "submissions.remaining": "Faltan {count} confirmaciones",
    "submissions.remainingOne": "Falta 1 confirmación",
    "submissions.ready": "Lista para publicarse",
    "submissions.confirm": "Confirmar",
    "submissions.reject": "Rechazar",
    "submissions.confirmed": "Confirmaste esta feria",
    "submissions.rejected": "Rechazaste esta feria",
    "submissions.own": "Vos propusiste esta feria",
    "submissions.promoted": "¡Publicada! Ver la feria",
    "submissions.signInToConfirm": "Iniciá sesión para confirmar",
    "submissions.error": "No se pudo registrar tu voto. Intentá de nuevo.",
    "submissions.report": "Reportar",
    "submissions.days": "Días",
    "submissions.hours": "Horario",
    "submissions.notFound": "No encontramos esta feria propuesta.",
    "submissions.loadMore": "Ver más",
    "submissions.backToList": "← Volver a las ferias propuestas",

    "moderation.queue.submission": "Feria propuesta",
  },
  en: {
    "app.title": "La Feria CR",
    ...
    "provenance.official": "Official (2026 list)",
    "provenance.community": "Community-added",
    "provenance.officialShort": "Official",
    "provenance.communityShort": "Community",
    ...
    "submitMarket.subtitle":
      "Know a market that isn't listed? Propose it and the community confirms it.",
    "submitMarket.signInRequired": "Sign in to propose a market.",
    "submitMarket.name": "Market name",
    "submitMarket.namePlaceholder": "e.g. Feria de Naranjo",
    "submitMarket.region": "Region",
    "submitMarket.regionPlaceholder": "Choose a region",
    "submitMarket.days": "Days",
    "submitMarket.hours": "Hours",
    "submitMarket.hoursPlaceholder": "e.g. 6am–1pm",
    "submitMarket.reference": "Landmark reference",
    "submitMarket.referencePlaceholder": "e.g. Next to the Palí",
    "submitMarket.mapUrl": "Google Maps link",
    "submitMarket.mapUrlPlaceholder": "https://maps.google.com/…",
    "submitMarket.organizer": "Organizer",
    "submitMarket.phone": "Phone",
    "submitMarket.location": "Location",
    "submitMarket.pickOnMap": "Tap the map to drop a pin (optional).",
    "submitMarket.useMyLocation": "Use my location",
    "submitMarket.locationSelected": "Location selected",
    "submitMarket.submit": "Propose market",
    "submitMarket.submitting": "Submitting…",
    "submitMarket.success":
      "Thanks! Your market is pending confirmation from the community.",
    "submitMarket.viewPending": "View proposed markets",
    "submitMarket.error": "Couldn't submit. Check the fields and try again.",
    "submitMarket.rateLimited": "Too many submissions. Try again later.",
    "submitMarket.required": "Fill in the name, region, and at least one day.",

    "duplicates.warningTitle": "Possible duplicates",
    "duplicates.warningBody":
      "Similar markets already exist. Review them before continuing; you can still propose it.",
    "duplicates.near": "{meters} m away",
    "duplicates.checking": "Checking for duplicates…",

    "submissions.title": "Proposed markets",
    "submissions.subtitle":
      "Community-added markets awaiting confirmation. Sign in to confirm them.",
    "submissions.empty": "No proposed markets right now.",
    "submissions.addCta": "Propose a market",
    "submissions.remaining": "{count} more confirmations needed",
    "submissions.remainingOne": "1 more confirmation needed",
    "submissions.ready": "Ready to publish",
    "submissions.confirm": "Confirm",
    "submissions.reject": "Reject",
    "submissions.confirmed": "You confirmed this market",
    "submissions.rejected": "You rejected this market",
    "submissions.own": "You proposed this market",
    "submissions.promoted": "Published! View the market",
    "submissions.signInToConfirm": "Sign in to confirm",
    "submissions.error": "Couldn't record your vote. Try again.",
    "submissions.report": "Report",
    "submissions.days": "Days",
    "submissions.hours": "Hours",
    "submissions.notFound": "We couldn't find this proposed market.",
    "submissions.loadMore": "Load more",
    "submissions.backToList": "← Back to proposed markets",

    "moderation.queue.submission": "Proposed market",
  },
};
